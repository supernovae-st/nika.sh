...
const CORE = [
  ...
  ['The proof', '/how/proof', 'run graph · conformance · machine surfaces'],
...
export function compilePalette() {
  ...
  /* lens sets · the registers as first-class entries (G.8 · Q9 ratified).
  ...
  const sets = parseYaml(readFileSync(join(ROOT, 'scripts/lens/graph/sets.yaml'), 'utf8')).sets
