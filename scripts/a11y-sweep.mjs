...
const CORE_ROUTES = ['/', '/manifesto', '/fr/manifesto', '/es/manifesto', '/de/manifesto', '/pt-br/manifesto', '/ja/manifesto', '/ko/manifesto', '/zh-hans/manifesto', '/play', '/install', '/install/arm64', '/install/servers', '/install/local-models', '/learn', '/spec', '/use-cases', '/sdk', '/sdk/local', '/sdk/local/run-and-cancel', '/sdk/remote/client', '/blog', '/blog/arm64-ai-workflows-on-linux-servers', '/blog/four-verbs', '/blog/intent-as-code', '/blog/own-your-stack', '/blog/dag-for-free', '/blog/blast-radius-in-the-file', '/blog/standard-library-not-plugin-store', '/blog/open-spec-copyleft-engine', '/blog/the-note-that-started-it', '/blog/naming-the-drum', '/blog/starting-over-on-purpose', '/blog/the-trace-you-can-replay', '/blog/anatomy-of-a-verb', '/blog/the-cost-line', '/blog/series/origin-ledger', '/blog/the-file-came-before-the-language', '/changelog', '/map', '/catalog', '/convert', '/brand']
function lensRoutes() {
