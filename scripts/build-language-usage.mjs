...
const refsBanner = `// language-usage-refs.generated.ts — AUTO-GENERATED by scripts/build-language-usage.mjs
...
const OUT_REFS = join(ROOT, 'src', 'content', 'language-usage-refs.generated.ts')
writeFileSync(
  OUT_REFS,
  `${refsBanner}${JSON.stringify(Object.fromEntries(entries.map((e) => [e.word, { templates: e.templates, codes: e.codes }])), null, 2)}\n`,
)
