...
export function discoverPrerenderPaths(root) {
  ...
  for (const name of [
    'BLOG_PATHS', 'BLOG_TAG_PATHS', 'BLOG_SERIES_PATHS', 'MANIFESTO_PATHS', 'INSTALL_PATHS', 'INSTALL_GUIDE_PATHS', 'SDK_SECTION_PATHS', 'SDK_GUIDE_PATHS', 'ERROR_PATHS', 'TOOL_PATHS',
