...
const COMPONENT_FEATURE = {
  ...
  Sdk: 'product.sdk',
  SdkSection: 'product.sdk',
  SdkGuide: 'product.sdk',
  ...
  /* the specification's register + its 18 chapter rooms (V3 · 2026-08-02) */
  SpecHub: 'site.spec',
  ChapterRoom: 'product.spec_chapter',
...
const FEATURE_EVIDENCE = {
  ...
  'product.sdk': 'src/content/sdk.ts',
  ...
  'site.spec': 'src/pages/SpecHub.tsx',
  'product.spec_chapter': 'src/pages/ChapterRoom.tsx',
