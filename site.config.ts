...
export const BLOG_PATHS = [
  ...
  '/blog/the-access-layer-is-an-operating-contract',
  '/blog/workflow-ecosystem-field-guide',
  '/blog/coding-agents-write-plans',
  '/blog/ci-without-ambient-authority',
  '/blog/retire-the-prompt-glue',
  '/blog/intent-as-code-engineering-discipline',
  '/blog/the-run-keeps-its-receipt',
  '/blog/the-two-clocks-behind-a-model-string',
  '/blog/one-workflow-three-local-model-lanes',
  '/blog/mcp-with-a-blast-radius',
...
/* how the standard changes (2026-08-02) · the NEPs shipped inside the spec
   ...
   THE FOLD (spec 2026-08-13 · read at the f308fa32 pin): the drafts stopped
   being proposals — eighteen became the language, two were buried — and only
   NEP-0000 (the process) remains in governance/. The nineteen retired rooms
   keep their addresses as doorways onto the chapter each law lives in now
   (sets.yaml legacy_moves · nep-fold-0109 · the append-only law). */
export const NEP_PATHS = ['/language/governance', '/language/governance/nep-0000-the-nep-process']
