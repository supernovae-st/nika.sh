...
export const NIKA_MATERIAL = { plate: { radius_px: 7, pad_px: 7, bevel: 0.06, bevel_lit: 0.15, grain: 0.03, lift_px: 3, contact: { y_px: 1, blur_px: 3, alpha: 0.38 }, ambient: { y_px: 24, blur_px: 40, spread_px: -24, alpha: 0.55 } }, well: { inset_alpha: 0.4, glow_alpha: 0.05 }, lamp: { reach_vmax: 60, core: 0.1, falloff: 0.22, drift_s: 40 }, motion: { lift_ms: 190, drawer_ms: 420, ease_lift: 'linear(0, 0.1 6%, 0.54 19%, 0.85 32%, 0.97 42%, 1.02 50%, 1.008 70%, 1)', ease_drawer: 'linear(0, 0.04 8%, 0.38 24%, 0.78 42%, 1.04 62%, 0.99 78%, 1)' } } as const
