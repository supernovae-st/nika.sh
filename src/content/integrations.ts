...
export const INTEGRATIONS: IntegrationEntry[] = [
  ...
  },
  {
    id: 'audit-workflow',
    kind: 'surface',
    name: 'the site-audit, archived',
    title: 'nika-site-audit · a full SEO audit as one file (frozen)',
    repo: 'https://github.com/supernovae-st/nika-site-audit',
    license: 'Apache-2.0',
    what: 'A full SEO + GEO site audit as ONE workflow file: discover, crawl bounded, score deterministically, one narrated verdict. Archived on 2026-07-29 and kept public as evidence that a workflow ran at real scale against real websites.',
    how: 'Ten tasks, five waves, and the diagram in its README is generated by `nika inspect --format mermaid`, not drawn by hand. It is read-only now: it was written in an earlier era and reading it teaches a dialect the engine has moved past. Deleting the evidence was never an option; advertising it as a starting point stopped being honest. Start from the template instead.',
    install: [
      { text: 'Start here instead, working from the first push', code: 'gh repo create --template supernovae-st/nika-actions-starter' },
