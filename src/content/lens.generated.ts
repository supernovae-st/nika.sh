// lens.generated.ts — AUTO-GENERATED by scripts/lens/graph/build-lens.mjs from
...
export const LENS_NODES: LensNode[] = [
  ...
  {
    "id": "code:NIKA-AUTH-011",
    "kind": "member",
    "set": "error-codes",
    "layer": "refusals",
    "title": "NIKA-AUTH-011",
    "url": "/language/errors/NIKA-AUTH-011",
    "status": "ratified",
    "opener": "a lift: entry whose named law would not have fired on this task — a trapdoor that lifts nothing is refused, never a silent no-op (10 §the authored doors rule 6)",
    "meta": {
      "category": "validation_error",
      "transient": false
    }
  ...
  {
    "id": "code:NIKA-DAG-008",
    "kind": "member",
    "set": "error-codes",
    "layer": "refusals",
    "title": "NIKA-DAG-008",
    "url": "/language/errors/NIKA-DAG-008",
    "status": "ratified",
    "opener": "a group.<name> fold names a group no task declares — including a bare group and the group a renamed member left empty",
    "meta": {
      "category": "validation_error",
      "transient": false
    }
  ...
  {
    "id": "code:NIKA-DAG-009",
    "kind": "member",
    "set": "error-codes",
    "layer": "refusals",
    "title": "NIKA-DAG-009",
    "url": "/language/errors/NIKA-DAG-009",
    "status": "ratified",
    "opener": "an unwind task declares group: — cleanup never enters G_p, so it cannot be a fan-in member",
    "meta": {
      "category": "validation_error",
      "transient": false
    }
  ...
  {
    "id": "code:NIKA-INFER-004",
    "kind": "member",
    "set": "error-codes",
    "layer": "refusals",
    "title": "NIKA-INFER-004",
    "url": "/language/errors/NIKA-INFER-004",
    "status": "ratified",
    "opener": "the provider spent tokens yet the visible answer is empty — a thinking model ate the budget on its reasoning trace (fail-closed · #651 · raise max_tokens or use a no-think variant)",
    "meta": {
      "category": "validation_error",
      "transient": false
    }
  ...
  },
  {
    ...
    "status": "ratified",
    "opener": "missing envelope field (nika: / non-empty tasks:)",
    "meta": {
      "category": "validation_error",
      "transient": false
    }
  },
  {
    ...
    "status": "ratified",
    "opener": "nika: is not a kebab-case id (^[a-z][a-z0-9-]*$)",
    "meta": {
      "category": "parse_error",
      "transient": false
    }
  ...
  },
  {
    ...
    "status": "ratified",
    "opener": "with:/extract: binding uses a reserved name (output · status · error · started_at · ended_at · duration_ms)",
    "meta": {
      "category": "validation_error",
      "transient": false
    }
  ...
  },
  {
    ...
    "status": "ratified",
    "opener": "data-as-code sink · a nika:fetch resolved URL path names a code-bearing class (serialized-executable · script/interpreter · executable binary/module · the closed NEP-0006 list) and the task declares no door — no lift: entry naming the data-as-code law · the read hides an execution sink (F-O7 · NEP-0006)",
    "meta": {
      "category": "security_error",
      "transient": false
    }
  ...
  {
    "id": "code:NIKA-SEC-015",
    "kind": "member",
    "set": "error-codes",
    "layer": "refusals",
    "title": "NIKA-SEC-015",
    "url": "/language/errors/NIKA-SEC-015",
    "status": "ratified",
    "opener": "the order law — an exec: task sits transitively downstream of a net-effecting task (nika:fetch · nika:notify) over the derived graph (with: data edges ∪ after: control edges) · content the workflow did not author must not reach a shell · UNCONDITIONAL: no block declares it and none can disable it",
    "meta": {
      "category": "security_error",
      "transient": false
    }
  ...
  },
  {
    ...
    "status": "ratified",
    "opener": "a tasks.* reference outside the boundary (with: · after: · on_error.recover · an unwind task reading its producer · workflow outputs) — hoist it into with: (check --fix applies it)",
    "meta": {
      "category": "validation_error",
      "transient": false
    }
  ...
  {
    "id": "post:ci-without-ambient-authority",
    "kind": "surface",
    "title": "The CI job should know its boundary",
    "url": "/blog/ci-without-ambient-authority",
    "status": "both",
    "opener": null,
    "exists": true
  },
  ...
  {
    "id": "post:coding-agents-write-plans",
    "kind": "surface",
    "title": "Let coding agents write plans, not policy",
    "url": "/blog/coding-agents-write-plans",
    "status": "both",
    "opener": null,
    "exists": true
  },
  ...
  {
    "id": "post:intent-as-code-engineering-discipline",
    "kind": "surface",
    "title": "Intent as Code is an engineering discipline",
    "url": "/blog/intent-as-code-engineering-discipline",
    "status": "both",
    "opener": null,
    "exists": true
  },
  {
    "id": "post:mcp-with-a-blast-radius",
    "kind": "surface",
    "title": "MCP with a blast radius",
    "url": "/blog/mcp-with-a-blast-radius",
    "status": "both",
    "opener": null,
    "exists": true
  },
  ...
  {
    "id": "post:retire-the-prompt-glue",
    "kind": "surface",
    "title": "Retire the prompt glue",
    "url": "/blog/retire-the-prompt-glue",
    "status": "both",
    "opener": null,
    "exists": true
  },
  ...
  {
    "id": "post:the-access-layer-is-an-operating-contract",
    "kind": "surface",
    "title": "The access layer is an operating contract",
    "url": "/blog/the-access-layer-is-an-operating-contract",
    "status": "both",
    "opener": null,
    "exists": true
  },
  ...
  {
    "id": "post:the-two-clocks-behind-a-model-string",
    "kind": "surface",
  ...
  {
    "id": "post:workflow-ecosystem-field-guide",
    "kind": "surface",
    "title": "A field guide to the Nika workflow ecosystem",
    "url": "/blog/workflow-ecosystem-field-guide",
    "status": "both",
    "opener": null,
    "exists": true
  },
  ...
  },
  {
    ...
    "url": "/truth",
    "status": "ratified",
    "opener": "The vocabulary of how this site tells the truth: spec, canon, schema, pack, pin, catalog, mirror, registry, manifest, lens. Each word has exactly one meaning · confusing two of them is a prose bug.",
    "closed": false,
    "counted_in_canon": false,
    "surface": "anchors",
    "clock": "spec",
  ...
  },
  {
    ...
    "url": "/language",
    "status": "ratified",
    "opener": "Typed contracts for task outputs: returns and decode, written inline · the closed primitive grammar below is the whole register since 0.109 (a named `types:` block resolves to nothing; spec/09-types.md).",
    "closed": false,
    "counted_in_canon": false,
    "surface": "anchors",
    "clock": "spec",
  ...
  {
    "id": "showcase:corpus-digest",
    "kind": "member",
    "set": "showcases",
    "layer": "proof",
    "title": "corpus-digest",
    "url": "/workflows/jobs/corpus-digest",
    "status": "ratified",
    "opener": null,
    "meta": {
      "tier": null,
  ...
  },
  {
    ...
    "url": "/language/words/backoff_max_ms",
    "status": "ratified",
  ...
  },
  {
    ...
    "url": "/language/words/backoff_strategy",
    "status": "ratified",
  ...
  },
  {
    ...
    "layer": "shape",
    "title": "because",
    "url": "/language/words/because",
    "status": "ratified",
    "opener": "The non-empty justification · recorded in the run receipt with the taint path and the value digest.",
    "meta": {
      "scopes": [
        "lift"
      ],
  ...
  },
  {
    ...
    "layer": "shape",
    "title": "fail_fast",
    "url": "/language/words/fail_fast",
    "status": "ratified",
    "opener": "Whether the fan-out abandons the batch on the first failure · default true. False finishes every item and yields null at a failed index, so the batch reports what it could.",
    "meta": {
      "scopes": [
        "for_each"
      ],
  ...
  },
  {
    ...
    "layer": "shape",
    "title": "for_each",
    "url": "/language/words/for_each",
    "status": "ratified",
    "opener": "Fan this task out over a collection · ONE block, so the concurrency is visible where the fan-out is declared. `max_parallel` and `fail_fast` live here because they have no meaning without it.",
    "meta": {
      "scopes": [
        "task"
      ],
  ...
  },
  {
    ...
    "layer": "shape",
    "title": "from",
    "url": "/language/words/from",
    "status": "ratified",
    "opener": "REQUIRED for law 'taint', forbidden otherwise · the ONE binding this entry raises (e.g. inputs.p · config.region · tasks.fetch.output) · a dotted value-binding path.",
    "meta": {
      "scopes": [
        "lift"
      ],
  ...
  },
  {
    ...
    "layer": "shape",
    "title": "items",
    "url": "/language/words/items",
    "status": "ratified",
    "opener": "The collection · a `${{ ... }}` reference OR a literal array. Evaluated EXACTLY ONCE, before the fan-out; no iteration feeds back into it (spec 03 §where this sits).",
    "meta": {
      "scopes": [
        "for_each"
      ],
  ...
  },
  {
    ...
    "layer": "shape",
    "title": "law",
    "url": "/language/words/law",
    "status": "ratified",
    "opener": "WHICH law this entry lifts · 'taint' raises ONE binding from untrusted to trusted (NEP-0004 · LAW-AUTH-0325) · 'data-as-code' declares this task's fetch a code-bearing artifact it will never load or run (NEP-0006 · LAW-AUTH-0327). Neither ever lifts the net boundary or the SSRF floor.",
    "meta": {
      "scopes": [
        "lift"
      ],
  ...
  },
  {
    ...
    "layer": "shape",
    "title": "max_attempts",
    "url": "/language/words/max_attempts",
    "status": "ratified",
  ...
  },
  {
    ...
    "layer": "shape",
    "title": "max_parallel",
    "url": "/language/words/max_parallel",
    "status": "ratified",
    "opener": "Cap concurrent iterations · default unbounded · 1 = sequential.",
    "meta": {
      "scopes": [
        "for_each"
      ],
  ...
  },
  {
    ...
    "url": "/language/words/max_tokens_total",
    "status": "ratified",
  ...
  },
  {
    ...
    "layer": "shape",
    "title": "skip",
    "url": "/language/words/skip",
    "status": "ratified",
    "opener": "Swallow the error and let the DAG continue · the task produces no output, and the original error stays readable at `tasks.<id>.error`. Exactly one of `recover` · `skip`.",
    "meta": {
      "scopes": [
        "on_error"
      ],
  ...
  },
  {
    ...
    "layer": "shape",
    "title": "temperature",
    "url": "/language/words/temperature",
    "status": "ratified",
  ...
  },
  {
    ...
    "layer": "shape",
    "title": "workflow",
    "url": "/language/words/workflow",
    "status": "ratified",
    "opener": "Compose another workflow (spec 14) · a STATIC target: a filesystem path OR registry:owner/name@version (pinned). A templated target is refused at check (NIKA-COMP-001). Exactly one of tool: | workflow: (the invoke tagged union · G21).",
    "meta": {
      "scopes": [
        "invoke"
      ],
...
const LENS_EDGES_2: LensEdge[] = [
  ...
  {
    "from": "post:ci-without-ambient-authority",
    "to": "tool:prompt",
    "kind": "mentions"
  },
  {
  ...
  {
    "from": "post:coding-agents-write-plans",
    "to": "tool:decide",
    "kind": "mentions"
  },
  {
  ...
  {
    "from": "post:intent-as-code-engineering-discipline",
    "to": "word:with",
    "kind": "mentions"
  },
  {
    "from": "post:mcp-with-a-blast-radius",
    "to": "word:agent",
    "kind": "mentions"
  },
  {
  ...
  {
    "from": "post:retire-the-prompt-glue",
    "to": "provider:mock",
    "kind": "mentions"
  },
  {
  ...
  {
    "from": "post:the-access-layer-is-an-operating-contract",
    "to": "tool:compose",
    "kind": "mentions"
  },
  {
  ...
  {
    "from": "post:workflow-ecosystem-field-guide",
    "to": "provider:mock",
    "kind": "mentions"
  },
  {
