...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: `The syntax is plain YAML, but the point is not the syntax. The point is the reviewable, enforced plan. The ${CANON.verbs} verbs (infer · exec · invoke · agent) are native execution models, each one explicit and typed, with a permits: block the runtime enforces before anything runs. The file is the control surface, not the formatting.`,
  },
  {
