/* ─── §use-cases · the tabbed explorer data ─────────────────────────────────
   ...
   nika-spec/examples/*.nika.yaml — each file passes the spec's
...
export interface UC {
  /** slug = filename without .nika.yaml · keys SHOWCASE_YAML + docs link */
  slug: string
  icon: string
  title: string
  body: string
