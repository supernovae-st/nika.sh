  ...
  },
  {
    ...
    cases: [
      ...
      },
      {
        ...
        icon: '🚂',
        title: 'Release train',
        body: 'Gates run in parallel, a human signs the GO with full information, the train holds until the window, then ships and verifies.',
        tier: 'T4',
        outcome: 'The train departs on time or not at all, and the journal records it either way.',
      },
      {
  ...
  },
  {
    ...
    cases: [
      ...
      },
      {
        ...
        body: 'RFC 7396 merges the approved overrides, RFC 6902 diffs live prod. Only unsanctioned drift pages anyone.',
        tier: 'T3',
