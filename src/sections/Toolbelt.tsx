...
/* ─── § the toolbelt · the standard library as a constellation ──────────────
   Spec-true (nika-spec canon.yaml): 4 verbs stay locked — everything else
   is a tool. Builtin/provider/extract-mode counts derive from
   canon.generated.ts (the canon.yaml projection · never hand-typed here).
  ...
  return (
    <section id="toolbelt" className="mx-auto max-w-6xl scroll-mt-24 px-6 py-28 md:py-36">
      ...
      <p className="rv max-w-[42rem] text-[17px] leading-relaxed text-[var(--fg-mute)]">
        The language stays four verbs. The standard library does the rest. {CANON.builtins} builtins, any MCP
        server your editor already uses, and {CANON.providers} model providers. All reached the same way:{' '}
      ...
      {/* the providers · cloud row + sovereign local row */}
