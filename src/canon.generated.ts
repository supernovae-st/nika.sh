...
export const CANON = {
  ...
  builtins: 27,
  builtinNames: ["assert", "chart", "compose", "convert", "date", "done", "edit", "emit", "fetch", "glob", "grep", "hash", "image_fx", "image_generate", "inspect", "jq", "json_diff", "json_merge_patch", "log", "notify", "prompt", "read", "tts_generate", "uuid", "validate", "wait", "write"],
  providers: 16,
  providersCloud: 10,
  providersLocal: 5,
  providersTest: 1,
