...
/* ─── SectionHead · the ONE section masthead (FIG plate + title + lede) ───────
   ...
   so the masthead register can never drift again. The plate GRAMMAR (FIG N.n
   page-scoped plates · N.n.m sub-plates · letter mastheads on routed pages)
   is documented at the .v4fig block in src/shell/shell.css.
