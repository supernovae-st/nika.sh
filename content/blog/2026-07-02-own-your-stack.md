...
Cloud stays a real choice: <!-- canon:providersCloud -->11<!-- /canon --> cloud providers, with credentials supplied through the runtime's secret boundary rather than written into the workflow. The point was never no-cloud. The point is that cloud is **optional**: per workflow or task, visible in the requested model seat.
